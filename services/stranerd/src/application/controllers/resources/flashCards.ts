import { AddFlashCard, DeleteFlashCard, FindFlashCard, GetFlashCards, UpdateFlashCard } from '@modules/resources'
		...
		const data = validate({
			...
			set: {
				...
				rules: [
					...
					Validation.hasMoreThanX(0), Validation.hasLessThanX(26)
				]
			},
			tags: {
				required: true,
